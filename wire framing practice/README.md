...
## Activity tasks
1. **Registration screen** — Web & Mobile, responsive thinking ✅ (this repo)
2. Candidate-facing screens for the Job Recruitment Portal — not started
3. 5 static-page wireframes for a company site (Home, About Us, Teams, Services, Contact Us), exported to PDF — not started
4. **AI Twist** — generate the Registration screen with an AI design tool, critique it for responsiveness/WCAG/contrast, compare against the hand-built version — not started
